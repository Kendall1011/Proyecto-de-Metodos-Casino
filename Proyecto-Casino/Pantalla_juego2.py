...
class Pantalla_juego2:
    ...
    # El resto del código se mantiene como en la versión funcional compartida anteriormente...
    ...
    def dibujar(self, ventana):
        ...
        dinero_j1_texto = pequena.render(f"Jugador 1: {dinero_j1:,}", True, BLANCO)
        dinero_j2_texto = pequena.render(f"Jugador 2: {dinero_j2:,}", True, BLANCO)
        ventana.blit(dinero_j1_texto, (20, 500))
        ventana.blit(dinero_j2_texto, (ANCHO - dinero_j2_texto.get_width() - 20, 500))
