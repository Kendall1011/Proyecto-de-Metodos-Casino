...
class PantallaJuego:
    ...
    def dibujar(self, ventana):
        ...
        # Botones
        # Botón Eliminar (píldora)
        self.boton_borrar = pygame.Rect(30, 620, 100, 40)
        pygame.draw.rect(VENTANA, (180, 50, 50), self.boton_borrar, border_radius=20)
        texto_borrar = pequena.render("Eliminar", True, BLANCO)
        VENTANA.blit(texto_borrar, texto_borrar.get_rect(center=self.boton_borrar.center))

        # Botón Repetir (píldora)
        self.boton_repetir = pygame.Rect(770, 620, 100, 40)
        pygame.draw.rect(VENTANA, (50, 120, 200), self.boton_repetir, border_radius=20)
        texto_repetir = pequena.render("Repetir", True, BLANCO)
        VENTANA.blit(texto_repetir, texto_repetir.get_rect(center=self.boton_repetir.center))
